...
namespace MyBlog.Services.Concrete
{
    public class CategoryManager : ICategoryService
    {
        ...
        public async Task<IDataResult<Category>> Get(int categoryId) //Id'ye esit olan categori ve ona ait olan articles'ları getir...
        {
        ...
        {
            await _unitOfWork.Categories.AddAsync(new Category //son 4 deger biz eklemesekte gelir...
            {
                ...
                IsDeleted = false
            }).ContinueWith(t => _unitOfWork.SaveAsync()); //Task'le devam eder...
